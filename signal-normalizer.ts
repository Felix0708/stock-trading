...
const SIGNAL_RULES = [
  ...
  ["변동성 수축", "VOLATILITY_CONTRACTION", "CHECK"],
  ["채널 이탈 홀딩", "CHANNEL_EXIT_HOLD", "CHECK"],
  ["채널 이탈 보유", "CHANNEL_EXIT_HOLD", "CHECK"],
  ["박스권 신규진입 차단", "RANGE_ENTRY_BLOCK", "CHECK"],
  ["박스권 진입 차단", "RANGE_ENTRY_BLOCK", "CHECK"],
  ["휩쏘", "WHIPSAW_INFO", "CHECK"],
