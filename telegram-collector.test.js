...
const dialogs = [
  { isChannel: true, title: "무니인사이트 6.15~7.15", date: 100, id: 1 },
  { isChannel: true, title: "무니인사이트 7.15~8.15", date: 200, id: 2 },
  { isChannel: true, title: "다른 채널", date: 300, id: 3 },
];
assert.equal(chooseLatestChannel(dialogs, "무니인사이트").id, 2);
