...
이 저장소는 개인 포트폴리오와 교육·모의투자 목적으로 만든 비공식 프로젝트입니다. 특정 금융상품의 매수·매도 권유나 수익 보장을 제공하지 않으며, 실제 투자 판단과 손실에 대한 책임은 사용자에게 있습니다.
...
실계좌 주문은 구현하지 않았으며, 기본 동작은 주문을 만들지 않는 `SHADOW` 모드입니다. 외부 서비스의 이용약관과 데이터 라이선스를 확인한 뒤 사용하세요.
