...
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 2 }).quantity, 100);
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 2.2 }).quantity, 70);
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 2.5 }).quantity, 70);
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 2.58 }).quantity, 50);
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 3 }).quantity, 50);
assert.equal(calculatePositionSize({ ...base, conviction: "B", sbZScore: 3.15 }).quantity, 25);
