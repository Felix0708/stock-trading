...
assert.equal(shouldRetryMarketTransition(marketCloseRecord, new Error("[2000](RC4058:모의투자 장종료)"), afterOpen), true);
assert.equal(shouldRetryMarketTransition(marketCloseRecord, new Error("한투 모의 API 실패 [VTTT1001U]: 모의투자 장종료 입니다."), afterOpen), true);
